    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">Review and process Department of Land Registration applications</p>
            <Link href="/admin/applications">
              <Button className="w-full bg-blue-600 hover:bg-blue-700">Manage Applications</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">Verify submitted documents with AI assistance</p>
            <Link href="/admin/documents">
              <Button className="w-full bg-green-600 hover:bg-green-700">Verify Documents</Button>
            </Link>
          </CardContent>
        </Card>
